...
from simple_pred.data_types import Float3, Vector, Vector1, Img, Img1
MAX_SIZE = 21
...
def generate(pset, min_, max_, condition, type_=__type__):
    ...
    :param pset: A primitive set from which to select primitives of the trees.
    :param min_: Minimum height of the produced trees.
    :param max_: Maximum Height of the produced trees.
    ...
    while len(stack) != 0:
        ...
        if condition(height, depth):
            ...
            try:
                ...
                try:
                    if type_ == Vector or type_ == Vector1:
                        pass
                    depth -= 1
